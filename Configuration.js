...
function getEndpoints(deviceAddress, endpoints) {
  ...
  var e = endpoints.addEndpoint("16", "Contador de riego (PULSE-2)", endpointType.genericSensor);
  e.variableTypeId = 1369;
  var e = endpoints.addEndpoint("17", "Agua drenada (PULSE-1)", endpointType.genericSensor);
  e.variableTypeId = 1370;
}
